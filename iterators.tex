...
\tcode{value_type<I>::type} names that type, unless it is not an object type~(\ref{basic.types}) in which case
...
\begin{libsumtab}{Ranges library summary}{tab:iterables.lib.summary}
  ...
  \ref{iterable.primitives} & Range primitives   &   \tcode{<iterator>}      \\
