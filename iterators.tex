...
{\color{newclr}
\pnum
Unless otherwise stated, all the concepts, types, and functions in this chapter
are defined in the \tcode{std::\brk{}experimental::ranges_v1} namespace.
}
...
\rSec1[iterator.synopsis]{Header \tcode{<experimental/range_v1/iterator>}\ synopsis}
