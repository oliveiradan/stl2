...
\pnum
Overloads of algorithms that take \tcode{Range} arguments~(\ref{iterable.iterables})
...
\tcode{\textit{TAGGET}($D$, tag::$N$, $N$)} names a tagged getter~(\ref{taggedtup.tagged})
...
applications of the \changed{corresponding comparisons}{comparison function and projection}.
\end{itemdescr}
...
applications of the \changed{corresponding predicate}{comparison function and projection},
