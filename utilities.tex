...
\enterexample Objects \tcode{a} and \tcode{b} may not be reference-like
types (e.g. \tcode{reference_wrapper}~(\cxxref{refwrap})) that alias each
other.\exitexample
}
...
\begin{codeblock}
@\oldtxt{noexcept(declval<Base\&>() = forward<U>(u))}\newtxt{is_nothrow_assignable<Base\&, U>::value}@
\end{codeblock}
